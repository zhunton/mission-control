...
const AGENTS: Agent[] = [
  ...
  },
  {
    id: "dali",
    name: "Dali",
    role: "Image Developer",
    status: "working",
    emoji: "🎨",
    avatar: "/dali-painter.jpg",
    color: "#a855f7",
    description: "Conjures visuals, illustrations, and creative assets for Mission Control. Operates from the Alchemy Lab under Wally's direction.",
